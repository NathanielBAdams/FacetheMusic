...
let lick1 = new Howl({
	...
	onplay: function() {
		...
		images[0].src = './images/lick1.gif' + '?a=' + Math.random();
	},
	onmute: function() {
		ULplaying = false;
	},
...
let lick2 = new Howl({
	...
	onplay: function() {
		...
		images[2].src = './images/lick2.gif' + '?a=' + Math.random();
	},
	onmute: function() {
		URplaying = false;
	},
...
let lick3 = new Howl({
	...
	onplay: function() {
		...
		images[1].src = './images/lick3.gif' + '?a=' + Math.random();
	},
	onmute: function() {
		LLplaying = false;
	},
...
let lick4 = new Howl({
	...
	onplay: function() {
		...
		images[3].src = './images/lick4.gif' + '?a=' + Math.random();
	},
	onmute: function() {
		LRplaying = false;
	},
